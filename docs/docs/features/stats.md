...
The **Stats** page (header link or `/stats`) is a visual overview of your owned collection.

- **Summary tiles** — total cards, distinct printings, distinct cards, and an estimated USD value
  (foil stacks are valued at the foil price when available).
...
Everything is computed from the cards you own, so the page is empty until you
